...
const questions = [
	...
	},
	{
		...
		answers: [
			...
			{
				text: 'Output voltage occurs simultaneously with input voltage changes',
				correct: false
			},
	...
	{
		question:
			'Regarding the negative feedback amplifier, which of the following statements is wrong?',
		answers: [
	...
	},
	{
		...
		answers: [
			...
			{
				text: 'Does not improve the signal-to-noise ratio at I/O',
				correct: false
			},
	...
	},
	{
		...
		answers: [
			{
				text:
					'Feedback voltage is 180 degree out of phase with respect to input voltage',
				correct: true
			},
			{
				text:
					' Input voltage is 180 degree out of phase with respect to feedback voltage',
				correct: false
			},
			{
				text: 'Feedback voltage is in same phase with respect to input voltage',
				correct: false
			},
			{
				text: 'Input voltage is in same phase with respect to feedback voltage',
				correct: false
			}
		],
		explanation:
