...
const questions = [
	{
		...
		explanation:
			'Explantion: In CMOS fabrication, nMOS and pMOS are integrated in the same chip substrate. n-type and p-type devices are formed in the same structure.'
	},
	{
		...
		explanation:
			'Explantion: The arrow is to indicate the direction of electrons (opposite to the direction of conventional current flow).'
	},
	{
		question:
			'Neglecting Channel Length Modulation, if the transconductance of a MOSFET increases, the output impedance of the follower stage?',
		answers: [
		...
		explanation:
			'Explantion: The output impedance of a follower stage is (1/gm || Rd). If the transconductance increases, the output impedance will decrease, as can be seen from the formulae.'
	},
	{
		question:
		...
		explanation:
			'Explantion: If p-transistor is conducting and has small voltage between source and drain, then it is said to be in unsaturated resistive region.'
	},
	{
		question:
		...
		explanation:
			'Explantion: Use the standard mathematical expression to determine the value of kn. '
	},
	{
		...
		explanation:
			'Explantion: In both regions it can perform the task of a switch. '
	}
];
...
var CLIENT_ID =
	'347108569823-16ajosbbbj1n8bc1vkj5lp429vehm1sg.apps.googleusercontent.com';
